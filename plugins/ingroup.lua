...
local gp_type = data[tostring(msg.to.id)]['group_type']
  ...
  local text = "☇Gʀᴏᴜᴘ Sᴇᴛᴛɪɴɢs:☇\n🔽Lᴏᴄᴋ Nᴀᴍᴇ: "..settings.lock_name.."\n🔽Lᴏᴄᴋ Pʜᴏᴛᴏ: "..settings.lock_photo.."\n🔽Lᴏᴄᴋ Mᴇᴍʙᴇʀ: "..settings.lock_member.."\n🔽Lᴏᴄᴋ Lᴇᴀᴠᴇ: "..settings.leave_ban.."\n🔽Lᴏᴄᴋ Aʀᴀʙɪᴄ: "..settings.lock_arabic.."\n🔽Lᴏᴄᴋ Eɴɢʟɪsʜ: "..settings.lock_english.."\n🔽Lᴏᴄᴋ Cʜᴀᴛ: "..settings.lock_chat.."\n🔽Lᴏᴄᴋ Jᴏɪɴ: "..settings.lock_join.."\n🔽Lᴏᴄᴋ Tᴀɢ: "..settings.antitag.."\n🔽Lᴏᴄᴋ Lɪɴᴋ: "..settings.lock_ads.."\n🔽Lᴏᴄᴋ Eᴍᴏᴊɪ: "..settings.antiemoji.."\n🔽Lᴏᴄᴋ Sʜᴀʀᴇ: "..settings.lock_share.."\n🔽Lᴏᴄᴋ Vɪᴅᴇᴏ: "..settings.lock_video.."\n🔽Lᴏᴄᴋ Vᴏɪᴄᴇ: "..settings.lock_voice.."\n➖➖➖➖➖➖➖➖➖➖\n☇Gʀᴏᴜᴘ Aʙᴏᴜᴛ☇\n🔘Fʟᴏᴏᴅ Sᴇɴsɪᴛɪᴠɪᴛʏ: "..NUM_MSG_MAX.."\n🤖Bᴏᴛ Pʀᴏᴛᴇᴄᴛɪᴏɴ: "..bots_protection.."\n🔸Gʀᴏᴜᴘ Exᴘɪʀᴇ﹕ Fᴏʀ Eᴠᴇʀ\n🔹Gʀᴏᴜᴘ Tʏᴘᴇ: "..gp_type.."\n➖➖➖➖➖➖➖➖➖➖\n☇Bσт Aвσυт☇\n🔼Ɓσт Ʋєяѕιση: 1.2\nDᴇᴠᴇʟᴏᴘᴇᴅ Bʏ @MrJacki\nCнαɴɴel: @Turbo_Team"
  return text
end
